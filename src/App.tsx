// ==========================
// Version 6 — src/App.tsx
// - v5 + Admin route: /admin (admin-only)
// ==========================
...
function WaveLayer() {
  return (
    <div className="pointer-events-none absolute inset-0">
      {/* White wave set */}
      <svg className="absolute inset-0 h-full w-full opacity-[0.22]" viewBox="0 0 1440 900" preserveAspectRatio="none">
        <defs>
      ...
      {/* Neon wave set */}
      <svg className="absolute inset-0 h-full w-full opacity-[0.18] mix-blend-screen" viewBox="0 0 1440 900" preserveAspectRatio="none">
        <defs>
      ...
      <div className="relative min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative rounded-2xl border border-white/14 bg-gradient-to-b from-white/[0.10] to-white/[0.04] backdrop-blur-2xl shadow-[0_44px_110px_-70px_rgba(0,0,0,0.98)]">
              <div className="pointer-events-none absolute inset-0">
              ...
              <div className="relative p-6 sm:p-7 text-center">
                ...
                <div className="mt-6 flex items-center justify-center gap-2">
                  <Link
                    to="/"
                    className="inline-flex items-center rounded-xl border border-white/14 bg-white/[0.10] px-4 py-2 text-sm font-semibold text-white hover:bg-white/[0.14] shadow-[0_28px_80px_-60px_rgba(0,0,0,0.98)]"
                  >
                    Back to Dashboard
                  </Link>
                  ...
                  <Link
                    to="/habits"
                    className="inline-flex items-center rounded-xl border border-white/14 bg-white/[0.08] px-4 py-2 text-sm font-semibold text-white/90 hover:bg-white/[0.12]"
                  >
                    Go to Habits
                  </Link>
                </div>

                <div className="mt-5 text-xs text-white/45">If you typed the URL manually, double-check the spelling.</div>
              </div>
